 ...
 *   https://datatables.net/download/#bs-3.3.5/jqc-1.11.3,dt-1.10.10,cr-1.3.0,fc-3.2.0,fh-3.1.0,rr-1.1.0
 *
 * Included libraries:
 *   jQuery compat 1.11.3, Bootstrap 3.3.5, DataTables 1.10.10, ColReorder 1.3.0, FixedColumns 3.2.0, FixedHeader 3.1.0, RowReorder 1.1.0
 */
...
m.ext=s={buttons:{},classes:{},build:"bs-3.3.5/jqc-1.11.3,dt-1.10.10,cr-1.3.0,fc-3.2.0,fh-3.1.0,rr-1.1.0",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:m.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:m.version};h.extend(s,{afnFiltering:s.search,aTypes:s.type.detect,ofnSearch:s.type.search,oSort:s.type.order,afnSortData:s.order,aoFeatures:s.feature,oApi:s.internal,oStdClasses:s.classes,
